...
#define AW_EDID_DTD_MAX_SIZE 		32
typedef struct {
	dw_edid_standard_t edid_mStandard[8];
//	unsigned int edid_mStandard[8];
	unsigned int edid_mStandardIndex;

	/* Array to hold all the parsed Detailed Timing Descriptors. */
	dw_dtd_t edid_mDtd[AW_EDID_DTD_MAX_SIZE];
