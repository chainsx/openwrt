...
struct vep_config_info {
	...
	u32 dlc_exist[DE_NUM][VI_CHN_NUM];
...
/* dlc function declaration */
s32 de_dlc_init(u32 disp, u32 chn, uintptr_t reg_base, u8 __iomem **phy_addr, u8 **vir_addr, u32 *size);
s32 de_dlc_exit(u32 disp, u32 chn);
s32 de_dlc_get_reg_blocks(u32 disp, u32 chn, struct de_reg_block **blks, u32 *blk_num);
...
s32 de_dlc_pq_proc(u32 sel, u32 cmd, u32 subcmd, void *data);
...
s32 de_gamma_get_reg_blocks(u32 disp,
	struct de_reg_block **blks, u32 *blk_num);
s32 de_gamma_enable(u32 disp, u32 chn, enum gamma_type type, u32 en);
s32 de_gamma_set_size(u32 disp, u32 chn, enum gamma_type type, u32 width, u32 height);
s32 de_gamma_set_window(u32 disp, u32 win_en,
	struct de_rect_o window);
s32 de_gamma_init_para(u32 disp, u32 chn, enum gamma_type type);
s32 de_gamma_info2para(u32 disp, u32 fmt,
	u32 dev_type, struct gamma_data *para,
	u32 bypass);
s32 de_gamma_set_csc(u32 disp, u32 chn, enum gamma_type type, u32 en, int *csc_coeff, enum de_data_bits db);
s32 de_gamma_set_table(u32 disp, u32 chn, enum gamma_type type, u32 en, bool is_gamma_tbl_10bit, u32 *gamma_tbl);
