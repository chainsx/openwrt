...
#define DE_DISP_OFFSET(disp)   (0x1C0000 + DE_DISP_SIZE * (disp))

#define CHN_CSC2_SIZE            (0x00100)
#define CHN_CSC2_OFFSET(csc_id)  (0x00100 + CHN_CSC2_SIZE * (csc_id))
#define CHN_CCSC_OFFSET          (0x00800) /* avoid compile err */
...
#define DISP_CSC2_SIZE           (0x00100)
#define DISP_CSC2_OFFSET(csc_id) (0x00100 + DISP_CSC2_SIZE * (csc_id))
...
enum de_rtwb_mux_id {
	RTWB_MUX_FROM_DSC0     = 0,
	RTWB_MUX_FROM_BLENDER0 = 1,
	RTWB_MUX_FROM_DSC1     = 2,
	RTWB_MUX_FROM_BLENDER1 = 3,
	RTWB_MUX_FROM_DSC2     = 4,
	RTWB_MUX_FROM_BLENDER2 = 5,
	RTWB_MUX_FROM_DSC3     = 6,
	RTWB_MUX_FROM_BLENDER3 = 7,
};

enum de_rtwb_mux_type {
	RTWB_MUX_BEFORE_DEP = 0,
	RTWB_MUX_AFTER_DEP  = 1,
};

enum de_irq_type {
	DE_IRQ_TYPE_RCQ         = 0x1 << 1,
	DE_IRQ_TYPE_RTMX_GLABAL = 0x1 << 0,
	DE_IRQ_TYPE_UNDEFINE    = 0x0,
};

enum de_rtmx_glabal_irq_flag {
	DE_IRQ_FLAG_HW_ERROR   = 0x1 << 8,
	DE_IRQ_FLAG_FRAME_END  = 0x1 << 4,
	DE_IRQ_FLAG_ERROR      = 0,
	DE_IRQ_FLAG_MASK =
		DE_IRQ_FLAG_HW_ERROR
		| DE_IRQ_FLAG_FRAME_END
		| DE_IRQ_FLAG_ERROR,
};

enum de_rcq_irq_flag {
	DE_RCQ_IRQ_FLAG_FINISH = 0x1 << 16,
	DE_RCQ_IRQ_FLAG_ACCEPT = 0x1 << 20,
	DE_RCQ_IRQ_FLAG_MASK =
		DE_RCQ_IRQ_FLAG_FINISH
		| DE_RCQ_IRQ_FLAG_ACCEPT,
};

enum de_rtmx_glabal_irq_state {
	DE_IRQ_STATE_HW_ERROR   = 0x1 << 1,
	DE_IRQ_STATE_FRAME_END  = 0x1 << 0,
	DE_IRQ_STATE_ERROR      = 0,
	DE_IRQ_STATE_MASK =
		DE_IRQ_STATE_HW_ERROR
		| DE_IRQ_STATE_FRAME_END
		| DE_IRQ_STATE_ERROR,
};

enum de_rcq_irq_state {
	DE_RCQ_IRQ_STATE_ACCEPT = 0x1 << 4,
	DE_RCQ_IRQ_STATE_FINISH = 0x1 << 0,
	DE_RCQ_IRQ_STATE_MASK =
		DE_RCQ_IRQ_STATE_ACCEPT
		| DE_RCQ_IRQ_STATE_FINISH,
};

enum de_wb_irq_flag {
	DE_WB_IRQ_FLAG_RCQ_FINISH = 0x1 << 16,
	DE_WB_IRQ_FLAG_RCQ_ACCEPT = 0x1 << 20,
	DE_WB_IRQ_FLAG_MASK =
...
enum de_wb_irq_state {
	DE_WB_IRQ_STATE_RCQ_FINISH = 0x1 << 0,
	DE_WB_IRQ_STATE_RCQ_ACCEPT = 0x1 << 4,
