...
enum aw_hdcp_type_e {
	AW_HDCP_TYPE_NULL = DW_HDCP_TYPE_NULL,
	AW_HDCP_TYPE_HDCP14 = DW_HDCP_TYPE_HDCP14,
	AW_HDCP_TYPE_HDCP22 = DW_HDCP_TYPE_HDCP22,
};
...
enum hdmi_vic {
	...
	HDMI_800x600P60 = HDMI_ESTABLE_BASE,
	HDMI_800x600P56,
	HDMI_640x480P75,
	HDMI_640x480P72,
	HDMI_640x480P67,
	...
	HDMI_1152x870P75 = 0x214,
	HDMI_ESTABLE_MAX = HDMI_1152x870P75,

	/* Standard Timings */
	HDMI_1152x864P75_4x3 = 0x215,
	HDMI_1280x768P60_5x4,
	HDMI_1280x800P60_16x10,
	HDMI_1280x960P60_4x3,
	HDMI_1280x1024P60_5x4,
	HDMI_1360x768P60_16x9,
	HDMI_1366x768P60_16x9,
	HDMI_1400x1050P60_4x3,
	HDMI_1440x900P60_16x10,
	HDMI_1600x900P60_16x9,
	HDMI_1680x1050P60_16x10,
	HDMI_1920x1200P60_16x10,
	HDMI_1920x1440P60_4x3,
};
...
static const struct cea_vic hdmi_cea_vics[] = {
	...
	/* Established Timing */
	__DEF_VIC(HDMI_720x400P70),
	__DEF_VIC(HDMI_720x400P88),
	__DEF_VIC(HDMI_640x480P67),
	__DEF_VIC(HDMI_640x480P72),
	__DEF_VIC(HDMI_640x480P75),
	__DEF_VIC(HDMI_800x600P56),
	__DEF_VIC(HDMI_800x600P60),
	__DEF_VIC(HDMI_800x600P72),
	__DEF_VIC(HDMI_800x600P75),
	__DEF_VIC(HDMI_832x624P75),
	__DEF_VIC(HDMI_1024x768P87),
	__DEF_VIC(HDMI_1024x768P60),
	__DEF_VIC(HDMI_1024x768P70),
	__DEF_VIC(HDMI_1024x768P75),
	__DEF_VIC(HDMI_1280x1024P75),
	__DEF_VIC(HDMI_1152x870P75),

	/* Standard Timing */
	__DEF_VIC(HDMI_1152x864P75_4x3),
	__DEF_VIC(HDMI_1280x768P60_5x4),
	__DEF_VIC(HDMI_1280x800P60_16x10),
	__DEF_VIC(HDMI_1280x960P60_4x3),
	__DEF_VIC(HDMI_1280x1024P60_5x4),
	__DEF_VIC(HDMI_1360x768P60_16x9),
	__DEF_VIC(HDMI_1366x768P60_16x9),
	__DEF_VIC(HDMI_1400x1050P60_4x3),
	__DEF_VIC(HDMI_1440x900P60_16x10),
	__DEF_VIC(HDMI_1600x900P60_16x9),
	__DEF_VIC(HDMI_1680x1050P60_16x10),
	__DEF_VIC(HDMI_1920x1200P60_16x10),
	__DEF_VIC(HDMI_1920x1440P60_4x3),
};
...
struct aw_phy_ops {
    ...
    u8 (*get_hpd)(void);
    void (*irq_all_mask)(void);
    u32 (*get_ir_state)(void);
