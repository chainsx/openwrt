...
#define SUNXI_RPROC_TRACE_VERSION "1.0.5"
				...
				size_t count, loff_t *ppos)
{
	...
	struct sunxi_rproc *chip = data->rproc->priv;
	aw_trace_event_parser_t *parser = &chip->trace_event_parser;
	...
	r_info->trace_event_obj = (aw_trace_event_t *)trace->va;
