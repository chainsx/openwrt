 ...
 */
static int notrace mbus_port_set_abs_bwlen(enum mbus_port port, bool en)
{
	unsigned int value;
 ...
 */
static int notrace mbus_port_set_abs_bwl(enum mbus_port port, unsigned int bwl)
{
	unsigned int value;
 ...
 */
static int notrace mbus_port_set_bw_saturation(enum mbus_port port,
 ...
 * @en: 0-disable, 1-enable
 */
static int notrace mbus_port_setbwlen(enum mbus_port port, bool en)
{
	unsigned int value;
 ...
 * @pri, priority
 */
static int notrace mbus_port_setpri(enum mbus_port port, bool pri)
{
 ...
 */
static int notrace mbus_port_setqos(enum mbus_port port, unsigned int qos)
{
	unsigned int value;
 ...
 */
static int notrace mbus_port_setwt(enum mbus_port port, unsigned int wt)
{
	unsigned int value;
 ...
 */
static int notrace mbus_port_setacs(enum mbus_port port, unsigned int acs)
{
	unsigned int value;
 ...
 * @bwl: the number of bandwidth limit
 */
static int notrace mbus_port_setbwl0(enum mbus_port port, unsigned int bwl0)
{
	unsigned int value;
 ...
 * @bwl: the number of bandwidth limit
 */
static int notrace mbus_port_setbwl1(enum mbus_port port, unsigned int bwl1)
{
	unsigned int value;
 ...
 * @bwl: the number of bandwidth limit
 */
static int notrace mbus_port_setbwl2(enum mbus_port port, unsigned int bwl2)
{
	unsigned int value;
...
static int mbus_init(struct platform_device *pdev)
{
	int ret = 0;
...
static void mbus_pmu_exit(void)
{
	platform_driver_unregister(&mbus_pmu_driver);
}

device_initcall(mbus_pmu_init);
module_exit(mbus_pmu_exit);
