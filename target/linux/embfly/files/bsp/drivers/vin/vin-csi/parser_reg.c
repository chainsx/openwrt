...
void csic_prs_fps_ds(unsigned int sel, struct prs_fps_ds *prs_fps_ds)
{
	...
	vin_reg_clr_set(csic_prs_base[sel] + PRS_PARSER_CAP_FRM_MASK0_REG_OFF,
		CH0_FRM_DATA_MASK_MASK, prs_fps_ds->ch0_frm_data_mask << CH0_FRM_DATA_MASK);
	vin_reg_clr_set(csic_prs_base[sel] + PRS_PARSER_CAP_FRM_MASK0_REG_OFF,
		CH1_FRM_DATA_MASK_MASK, prs_fps_ds->ch1_frm_data_mask << CH1_FRM_DATA_MASK);
	vin_reg_clr_set(csic_prs_base[sel] + PRS_PARSER_CAP_FRM_MASK1_REG_OFF,
		CH2_FRM_DATA_MASK_MASK, prs_fps_ds->ch2_frm_data_mask << CH2_FRM_DATA_MASK);
	vin_reg_clr_set(csic_prs_base[sel] + PRS_PARSER_CAP_FRM_MASK1_REG_OFF,
		CH3_FRM_DATA_MASK_MASK, prs_fps_ds->ch3_frm_data_mask << CH3_FRM_DATA_MASK);
}
