...
#define SENSOR_ID0_EN				0
#define SENSOR_ID0_EN_MASK			(0X1 << SENSOR_ID0_EN)
#define SENSOR_ID1_EN				1
#define SENSOR_ID1_EN_MASK			(0X1 << SENSOR_ID1_EN)
#define VE_ONLINE_ENV_MODE			4
#define VE_ONLINE_ENV_MODE_MASK			(0X1 << VE_ONLINE_ENV_MODE)
#define ID_EN_BK_DOOR				31
#define ID_EN_BK_DOOR_MASK			(0x1 << ID_EN_BK_DOOR)
...
#define STORED_FRM_THRESHOLD_MASK			(0XFF << STORED_FRM_THRESHOLD)

#define	CSIC_DMA_STORED_FRM_CNT_REG_OFF  	0X294
