...
void bsp_isp_map_reg_addr(unsigned long id, vin_dma_addr_t isp_reg_base)
{
...
void bsp_isp_map_load_dram_addr(unsigned long id, vin_dma_addr_t isp_load_dram_base)
{
#ifndef USE_DEF_PARA
 ...
 */
void bsp_isp_map_saved_dram_addr(unsigned long id, vin_dma_addr_t base)
{
