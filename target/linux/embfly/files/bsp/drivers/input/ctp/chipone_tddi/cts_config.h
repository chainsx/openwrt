...
/*** add for touchscreen compat by lxm 2023.9.21 start ***/
//extern char g_chipone_fw_boot_name[30];
/*** end ***/
...
#define CFG_CTS_DRIVER_VERSION              "v3.5.5"
...
/** Whether CTP regulator power is used */
//#define CFG_CTS_HAS_REGULATOR

#ifdef CFG_CTS_HAS_REGULATOR
#define VCC_VOLTAGE 3300000
#endif

/** Whether io3.3 to 1.8 en pin is used */
//#define CFG_CTS_HAS_IO_EN_PIN
...
#define CFG_CTS_OF_IO_EN_GPIO_NAME            "chipone,io-en-gpio"
...
#if defined(SKTL_AF86310VB)
	#if defined(SKTL_TP_11)
		#define SWAP_XY
		#define BOARD_Y_POL
		#define CTS_DEFAULT_MAX_WIDTH 1280
		#define CTS_DEFAULT_MAX_HEIGHT 800
	#else
		#define SWAP_XY
		#define BOARD_Y_POL
	    #define CTS_DEFAULT_MAX_WIDTH 1280
