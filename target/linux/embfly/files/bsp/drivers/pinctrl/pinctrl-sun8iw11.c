...
static const struct sunxi_desc_pin sun8iw11_pins[] = {
	...
	SUNXI_PIN(SUNXI_PINCTRL_PIN(B, 12),
		  ...
		  SUNXI_FUNCTION(0x4, "owa0"),	/* DI */
		  SUNXI_FUNCTION(0x7, "io_disabled")),
	SUNXI_PIN(SUNXI_PINCTRL_PIN(B, 13),
		  SUNXI_FUNCTION(0x0, "gpio_in"),
		  SUNXI_FUNCTION(0x1, "gpio_out"),
		  SUNXI_FUNCTION(0x2, "spi2"),		/* CS1 */
		  SUNXI_FUNCTION(0x4, "owa0"),	/* DO */
		  SUNXI_FUNCTION(0x7, "io_disabled")),
...
static int sun8iw11_pinctrl_probe(struct platform_device *pdev)
{
	...
	if (IS_ERR(bus_clk)) {
		sunxi_err(&pdev->dev, "fail to get bus_clk\n");
		return PTR_ERR(bus_clk);
	}
	ret = clk_prepare_enable(bus_clk);
	if (ret) {
		sunxi_err(&pdev->dev, "fail to enable bus_clk\n");
		return ret;
	}
