...
#define atbm_netif_rx_ni(_skb)									netif_receive_skb(_skb)
#else
...
#if (LINUX_VERSION_CODE > KERNEL_VERSION(6, 3, 0))   // 6.3.0 u8 mesh_control
#define atbm_amsdu_to_8023s(_skb, _list,_addr,_iftype,_extra_headroom)		\
		ieee80211_amsdu_to_8023s(_skb, _list, _addr, _iftype, _extra_headroom, NULL,NULL, 0)
#elif (LINUX_VERSION_CODE > KERNEL_VERSION(6, 2, 0)) // 6.2.0 bool mesh_control
#define atbm_amsdu_to_8023s(_skb, _list,_addr,_iftype,_extra_headroom)		\
