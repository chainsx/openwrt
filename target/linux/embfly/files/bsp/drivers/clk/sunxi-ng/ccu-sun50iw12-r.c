...
static SUNXI_CCU_GATE(bus_apb1_r_uart_clk, "bus-r-uart", "r-apb1",
		      0x18c, BIT(0), 0);
static SUNXI_CCU_GATE(bus_r_apb1_twi0_clk, "bus-r-twi0", "r-apb1",
		      0x19c, BIT(0), 0);
static SUNXI_CCU_GATE(bus_r_apb1_twi1_clk, "bus-r-twi1", "r-apb1",
		      0x19c, BIT(1), 0);
...
static struct ccu_common *sun50iw12_r_ccu_clks[] = {
	...
	&bus_r_apb1_twi0_clk.common,
	&bus_r_apb1_twi1_clk.common,
...
static struct clk_hw_onecell_data sun50iw12_r_hw_clks = {
	.hws	= {
		...
		[CLK_R_APB1_BUS_TWI0]	= &bus_r_apb1_twi0_clk.common.hw,
		[CLK_R_APB1_BUS_TWI1]	= &bus_r_apb1_twi1_clk.common.hw,
...
static struct ccu_reset_map sun50iw12_r_ccu_resets[] = {
	...
	[RST_R_APB1_BUS_TWI0]	=  { 0x19c, BIT(16) },
	[RST_R_APB1_BUS_TWI1]	=  { 0x19c, BIT(17) },
