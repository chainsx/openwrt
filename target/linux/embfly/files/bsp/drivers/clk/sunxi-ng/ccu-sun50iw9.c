...
static SUNXI_CCU_GATE(bus_twi0_clk, "bus-twi0", "apb2", 0x91c, BIT(0), 0);
static SUNXI_CCU_GATE(bus_twi1_clk, "bus-twi1", "apb2", 0x91c, BIT(1), 0);
static SUNXI_CCU_GATE(bus_twi2_clk, "bus-twi2", "apb2", 0x91c, BIT(2), 0);
static SUNXI_CCU_GATE(bus_twi3_clk, "bus-twi3", "apb2", 0x91c, BIT(3), 0);
static SUNXI_CCU_GATE(bus_twi4_clk, "bus-twi4", "apb2", 0x91c, BIT(4), 0);
...
static SUNXI_CCU_GATE(bus_owa_clk, "bus-owa", "apb1", 0xa2c, BIT(0), 0);
...
static SUNXI_CCU_GATE(hdmi_slow_clk, "hdmi-slow", "dcxo24M", 0xb04, BIT(31), CLK_IGNORE_UNUSED);
...
static SUNXI_CCU_GATE(bus_hdmi_clk, "bus-hdmi", "ahb3", 0xb1c, BIT(0), CLK_IGNORE_UNUSED);
