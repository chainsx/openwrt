...
static const char * const nsi_parents[] = { "dcxo24M", "pll-video0-3x", "pll-peri0-600m", "pll-peri0-480m" };
...
static const char * const mbus_parents[] = { "dcxo24M", "pll-peri0-600m", "pll-peri0-480m", "pll-peri0-400m" };
...
static SUNXI_CCU_GATE(ce_sys_ip_ahb_clk, "ce-sys-ip",
		"dcxo24M",
		0x0AC4, BIT(1), 0);

static SUNXI_CCU_GATE(ce_sys_ahb_clk, "ce-sys-ahb",
		"dcxo24M",
		0x0AC4, BIT(0), 0);
...
static const char * const usb2_mf_parents[] = { "dcxo24M", "pll-peri0-300m" };
...
static SUNXI_CCU_GATE(tcon_lcd0_ahb_clk, "tcon-lcd0-ahb",
		"dcxo24M",
		0x1504, BIT(0), 0);
...
static const char * const combophy0_parents[] = { "pll-video0-4x", "pll-video1-4x", "pll-video2-4x", "pll-peri0-2x", "pll-video0-3x", "pll-video1-3x", "pll-video1-3x" };
...
static const char * const tcon_tv0_parents[] = { "pll-video0-4x", "pll-video1-4x", "pll-video2-4x", "pll-peri0-300m", "pll-video0-3x", "pll-video1-3x", "pll-video1-3x" };
...
static struct clk_hw_onecell_data sun65iw1_hw_clks = {
	.hws    = {
		...
		[CLK_AHB_TCON_LCD0]		= &tcon_lcd0_ahb_clk.common.hw,
		...
		[CLK_CE_SYS_IP_AHB]		= &ce_sys_ip_ahb_clk.common.hw,
		[CLK_CE_SYS_AHB]		= &ce_sys_ahb_clk.common.hw,
	},
	.num = CLK_NUMBER,
};
/* ccu_def_end */
...
static struct ccu_common *sun65iw1_ccu_clks[] = {
	...
	&ve0_ahb_clk.common,
	&ce_sys_clk.common,
	&ce_sys_ip_ahb_clk.common,
	&ce_sys_ahb_clk.common,
	&gpu_ahb_clk.common,
	&memc_ahb_clk.common,
	&smhc0_clk.common,
