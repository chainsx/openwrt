...
static SUNXI_CCU_GATE(bus_twi0_clk, "bus-twi0", "apb1", 0x91c, BIT(0), 0);
static SUNXI_CCU_GATE(bus_twi1_clk, "bus-twi1", "apb1", 0x91c, BIT(1), 0);
static SUNXI_CCU_GATE(bus_twi2_clk, "bus-twi2", "apb1", 0x91c, BIT(2), 0);
static SUNXI_CCU_GATE(bus_twi3_clk, "bus-twi3", "apb1", 0x91c, BIT(3), 0);
...
static const char * const i2s_owa_tx_parents[] = { "pll-audio"};
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s0_clk, "i2s0", i2s_owa_tx_parents,
			     0xa10,
			     0, 5,
			     8, 2,
			     24, 3,
...
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s1_clk, "i2s1", i2s_owa_tx_parents,
			     0xa14,
			     0, 5,
			     8, 2,
			     24, 3,
...
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s2_clk, "i2s2", i2s_owa_tx_parents,
				  0xa14,
				  0, 5,
				  8, 2,
				  24, 3,
...
static const char * const owa_rx_parents[] = {"pll-periph0-2x",
						"pll-audio"};
static SUNXI_CCU_MP_WITH_MUX_GATE(owa0_rx_clk, "owa0-rx",
			     owa_rx_parents,
			     0xa30,
			     0, 5,	/* m */
			     8, 2,	/* p */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(owa0_tx_clk, "owa0-tx",
			     i2s_owa_tx_parents,
			     0xa34,
			     0, 5,	/* m */
			     8, 2,	/* p */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(owa1_rx_clk, "owa1-rx",
			     owa_rx_parents,
			     0xa40,
			     0, 5,	/* m */
			     8, 2,	/* p */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(owa1_tx_clk, "owa1-tx",
			     i2s_owa_tx_parents,
			     0xa44,
			     0, 5,	/* m */
			     8, 2,	/* p */
...
static SUNXI_CCU_GATE(bus_owa0_clk, "bus-owa0", "apb1", 0xa2c, BIT(0), 0);
...
static struct clk_hw_onecell_data sun50iw12_hw_clks = {
	.hws	= {
		...
		[CLK_BUS_OWA0]	= &bus_owa0_clk.common.hw,
		[CLK_BUS_OWA1]	= &bus_owa1_clk.common.hw,
...
static struct ccu_reset_map sun50iw12_ccu_resets[] = {
	...
	[RST_BUS_TWI0]		= { 0x91c, BIT(16) },
	[RST_BUS_TWI1]		= { 0x91c, BIT(17) },
	[RST_BUS_TWI2]		= { 0x91c, BIT(18) },
	[RST_BUS_TWI3]		= { 0x91c, BIT(19) },
	...
	[RST_BUS_OWA0]	= { 0xa2c, BIT(16) },
	[RST_BUS_OWA1]	= { 0xa2c, BIT(17) },
