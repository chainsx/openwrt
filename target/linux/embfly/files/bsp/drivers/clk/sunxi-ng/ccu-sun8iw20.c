...
static const char * const i2s_owa_tx_parents[] = { "pll-audio0", "pll-audio0-4x",
						    "pll-audio1-div2", "pll-audio1-div5" };
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s0_clk, "i2s0", i2s_owa_tx_parents, 0xa10,
				  0, 5,		/* M */
				  8, 2,		/* N */
				  24, 3,	/* mux */
				  BIT(31),	/* gate */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s1_clk, "i2s1", i2s_owa_tx_parents, 0xa14,
				  0, 5,		/* M */
				  8, 2,		/* N */
				  24, 3,	/* mux */
				  BIT(31),	/* gate */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(i2s2_clk, "i2s2", i2s_owa_tx_parents, 0xa18,
				  0, 5,		/* M */
				  8, 2,		/* N */
				  24, 3,	/* mux */
				  BIT(31),	/* gate */
...
static SUNXI_CCU_MP_WITH_MUX_GATE(owa_tx_clk, "owa-tx", i2s_owa_tx_parents, 0xa24,
				  0, 5,		/* M */
				  8, 2,		/* N */
				  24, 3,	/* mux */
				  BIT(31),	/* gate */
...
static const char * const owa_rx_parents[] = { "pll-periph0", "pll-audio1-div2",
						 "pll-audio1-div5" };

static SUNXI_CCU_MP_WITH_MUX_GATE(owa_rx_clk, "owa-rx", owa_rx_parents, 0xa28,
				  0, 5,		/* M */
				  8, 2,		/* N */
				  24, 3,	/* mux */
				  BIT(31),	/* gate */
...
static SUNXI_CCU_GATE(bus_owa_clk, "bus-owa", "apb0", 0xa2c, BIT(0), 0);
