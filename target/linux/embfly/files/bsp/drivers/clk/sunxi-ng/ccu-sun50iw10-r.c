...
static SUNXI_CCU_GATE(r_apb2_twi0_clk, "r-apb2-twi0", "r-apb2",
		      0x19c, BIT(0), 0);

static SUNXI_CCU_GATE(r_apb2_twi1_clk, "r-apb2-twi1", "r-apb2",
		      0x19c, BIT(1), 0);
...
static struct ccu_common *sun50iw10_r_ccu_clks[] = {
	...
	&r_apb2_twi0_clk.common,
	&r_apb2_twi1_clk.common,
...
static struct clk_hw_onecell_data sun50iw10_r_hw_clks = {
	.hws	= {
		...
		[CLK_R_APB2_TWI0]	= &r_apb2_twi0_clk.common.hw,
		[CLK_R_APB2_TWI1]	= &r_apb2_twi1_clk.common.hw,
...
static struct ccu_reset_map sun50iw10_r_ccu_resets[] = {
	...
	[RST_R_APB2_TWI0]	=  { 0x19c, BIT(16) },
	[RST_R_APB2_TWI1]	=  { 0x19c, BIT(17) },
