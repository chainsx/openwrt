...
static SUNXI_CCU_GATE(owa1_clk, "owa1",
		"dcxo24M",
		0x0A2C, BIT(1), 0);

static SUNXI_CCU_GATE(owa0_clk, "owa0",
		"dcxo24M",
		0x0A2C, BIT(0), 0);

static const char * const owa0_rx_clk_parents[] = { "pll-peri0-400m", "pll-peri0-300m", "pll-audio" };

static SUNXI_CCU_M_WITH_MUX_GATE(owa0_rx_clk, "owa0-rx-clk",
		owa0_rx_clk_parents, 0x0A30,
		0, 5,	/* M */
		24, 3,	/* mux */
		BIT(31), 0);

static const char * const owa0_tx_parents[] = { "pll-audio-4x", "tvfe-audio-clk" };

static SUNXI_CCU_MUX_WITH_GATE(owa0_tx_clk, "owa0-tx",
		owa0_tx_parents, 0x0A34,
		24, 1,	/* mux */
		BIT(31), 0);

static const char * const owa1_rx_clk_parents[] = { "pll-peri0-400m", "pll-peri0-300m", "pll-audio" };

static SUNXI_CCU_M_WITH_MUX_GATE(owa1_rx_clk, "owa1-rx-clk",
		owa1_rx_clk_parents, 0x0A40,
		0, 5,	/* M */
		24, 3,	/* mux */
		BIT(31), 0);

static const char * const owa1_tx_parents[] = {"pll-audio-4x", "tvfe-audio-clk" };

static SUNXI_CCU_MUX_WITH_GATE(owa1_tx_clk, "owa1-tx",
...
static struct clk_hw_onecell_data sun55iw5_hw_clks = {
	.hws    = {
		...
		[CLK_OWA1]			= &owa1_clk.common.hw,
		[CLK_OWA0]			= &owa0_clk.common.hw,
