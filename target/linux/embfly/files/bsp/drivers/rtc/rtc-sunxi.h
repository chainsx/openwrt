...
struct sunxi_rtc_data {
	...
	u32 gpr_base_address;	/* Gernel-Purpose-Register physical base address, gpr_base_address = 0 represent Genernal-Purpose-Register base address is same with rtc */
