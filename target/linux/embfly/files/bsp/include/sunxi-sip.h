...
#ifdef CONFIG_ARM
#if defined(CONFIG_ARCH_SUN50I) || defined(CONFIG_ARCH_SUN55I)
...
#define CLEAR_DRAM_KEEP_RUNNING_REQ	(SUNXI_BASE + 0x17)
#define SET_DRAM_KEEP_RUNNING_REQ	(SUNXI_BASE + 0x18)
#define PMU_WAKEUP_IRQ			(SUNXI_BASE + 0x19)
...
#define CLEAR_DRAM_KEEP_RUNNING		(ARM_SVC_BASE + CLEAR_DRAM_KEEP_RUNNING_REQ)
#define SET_DRAM_KEEP_RUNNING		(ARM_SVC_BASE + SET_DRAM_KEEP_RUNNING_REQ)
#define GET_PMU_WAKEUP_IRQ		(ARM_SVC_BASE + PMU_WAKEUP_IRQ)
